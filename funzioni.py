...
class Client:
    ...
    def get_symbol_ticker(self,symbol,TimeOut):
    ...
    def orderMarketSell(self,symbol,quantity,TimeOut):
    ...
    def orderMarketSellLimit(self,symbol,quantity,price,TimeOut):
        orderID = casualOrderID()
    ...
    def orderMarketBuy(self,symbol,quantity,TimeOut):
        orderID = casualOrderID()
